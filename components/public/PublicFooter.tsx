    ...
    <footer className="border-t border-white/40 dark:border-white/10 px-4 sm:px-6 lg:px-8 py-12 bg-white/10 dark:bg-slate-950/40 backdrop-blur">
      <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400">
          <Image src="/bookorvia-logo.png" alt="Bookorvia" width={28} height={28} className="h-7 w-7 rounded-lg" />
          <span>© {new Date().getFullYear()} Bookorvia — Built for local businesses</span>
        </div>
